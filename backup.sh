...
gcloud auth activate-service-account firebase-adminsdk-l8t1h@modern-diode-339415.iam.gserviceaccount.com --key-file=/app/modern-diode-339415-firebase-adminsdk-l8t1h-9a1f830664.json
